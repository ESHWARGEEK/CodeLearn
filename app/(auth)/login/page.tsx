        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-[#13141f] px-4 text-slate-500">Or sign in with</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-slate-700 bg-slate-900/50 hover:bg-slate-800 hover:border-slate-600 py-3.5 text-sm font-medium text-white transition-all"
              type="button"
              disabled={isLoading}
            >
